package io.github.heyrutvik.turing

import eu.timepit.refined.api.Refined
import eu.timepit.refined.auto._
import eu.timepit.refined.numeric.NonNegative
import io.github.heyrutvik.turing.compile.{Compiler, ConfigContext, Keyword, Symbol, SymbolContext}
import io.github.heyrutvik.turing.dsl.Table.Entry
import io.github.heyrutvik.turing.dsl.{Table => RTable}
import io.github.heyrutvik.turing.encode.{DescriptionNumber, StandardDescription, StandardForm}
import io.github.heyrutvik.turing.interpret.Interpreter
import io.github.heyrutvik.turing.interpret.Interpreter.CompleteConfig
import io.github.heyrutvik.turing.standard.AST.{FC, Table => ASTTable}
import io.github.heyrutvik.turing.standard.{AST, S, Table => STable}
  ...
  implicit class RTableOps(rt: RTable) {
    ...
    def simulate(step: Int Refined NonNegative): Unit = {
      ...
      implicit val print: CompleteConfig => Unit = { complete =>
        Console.print {
          fansi.Bold.On(fansi.Color.Green(io.github.heyrutvik.turing.elaborate.removePrimes(cc1(complete.state)))) + ": " +
